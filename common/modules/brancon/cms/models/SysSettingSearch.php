...
/**
 * SysSettingSearch represents the model behind the search form about `common\modules\brancon\cms\models\SysSetting`.
 */
class SysSettingSearch extends SysSetting
{
    ...
    {
        return [
            [['sys_key', 'value', 'default_value', 'description'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'sys_key', $this->sys_key])
